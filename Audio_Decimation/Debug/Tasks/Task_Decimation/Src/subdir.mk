...
Tasks/Task_Decimation/Src/%.o Tasks/Task_Decimation/Src/%.su Tasks/Task_Decimation/Src/%.cyclo: ../Tasks/Task_Decimation/Src/%.c Tasks/Task_Decimation/Src/subdir.mk
...
clean-Tasks-2f-Task_Decimation-2f-Src:
	-$(RM) ./Tasks/Task_Decimation/Src/decimation_task.cyclo ./Tasks/Task_Decimation/Src/decimation_task.d ./Tasks/Task_Decimation/Src/decimation_task.o ./Tasks/Task_Decimation/Src/decimation_task.su ./Tasks/Task_Decimation/Src/fir_coeffes.cyclo ./Tasks/Task_Decimation/Src/fir_coeffes.d ./Tasks/Task_Decimation/Src/fir_coeffes.o ./Tasks/Task_Decimation/Src/fir_coeffes.su
