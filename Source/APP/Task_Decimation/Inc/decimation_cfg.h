/**
 * @file decimation_cfg.h
 * @brief Configuration macros for decimation task and audio processing.
 *
 * Contains hardware, buffer, and algorithm configuration macros for the decimation task.
 *
